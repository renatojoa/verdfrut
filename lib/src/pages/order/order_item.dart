    ...
    return Card(
      ...
      child: Theme(
        data: Theme.of(context)
            .copyWith(dividerColor: const Color.fromARGB(0, 240, 161, 161)),
        child: ExpansionTile(
          ...
          title: Column(
              ...
              children: [
                Text(
                  'Pedido: ${widget.orderItem.orderID}',
                  style: TextStyle(
                      fontSize: 14,
                ...
                Text(
                  utilsServices.formatDateTime(widget.orderItem.orderDate),
                ...
                children: [
                  Expanded(
                      ...
                      child: SizedBox(
                        height: 150,
                        child: ListView(
                          children: widget.orderItem.itens.map((orderItem) {
                            return Row(
                              children: [
                                Text('${orderItem.qtd} ${orderItem.item.unit}'),
                                Expanded(
                                  child: Padding(
                  ...
                  Expanded(
                      flex: 2,
                      child: OrderStatusFlow(
                        dueDateOrderPay: widget.orderItem.dueDateOrderPay
            ...
            Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: utilsServices
                        .priceToCurrency(widget.orderItem.finalPrice),
                    style: const TextStyle(
                      fontSize: 15,
                    ),
                  ),
